...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .sin-stock { color:#cc0000; font-weight:bold; }
        .con-stock { color:#007700; font-weight:bold; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="{{ $p->stock > 0 ? 'con-stock' : 'sin-stock' }}">{{ $p->stock }}</td>
    ...
    <div class="resumen">
        Total productos: <span>{{ $productos->count() }}</span> &nbsp;|&nbsp;
        Unidades en stock: <span>{{ $productos->sum('stock') }}</span>
    </div>
